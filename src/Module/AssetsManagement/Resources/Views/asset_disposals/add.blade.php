...
@endif
 <div class='row'>
    <form action="{{ route('asset_disposals.saving') }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<input type='text' name='form_disposal_date' value='{{ old('form_disposal_date') }}' class='form-control datepicker' placeholder='disposal_date'>
</div>
</div>
...
<input type='text' name='form_reason' value='{{ old('form_reason') }}' class='form-control' placeholder='reason'>
</div>
</div>
...
<input type='text' name='form_scrap_value' value='{{ old('form_scrap_value') }}' class='form-control' placeholder='scrap_value'>
</div>
</div>
...
<input type='text' name='form_remarks' value='{{ old('form_remarks') }}' class='form-control' placeholder='remarks'>
</div>
</div>
