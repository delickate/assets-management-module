...
@endif
 <div class='row'>
    <form action="{{ route('asset_returns.saving') }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<input type='text' name='form_return_date' value='{{ old('form_return_date') }}' class='form-control datepicker' placeholder='form_return_date'>
</div>
</div>
...
<input type='text' name='form_condition' value='{{ old('form_condition') }}' class='form-control' placeholder='form_condition'>
</div>
</div>
