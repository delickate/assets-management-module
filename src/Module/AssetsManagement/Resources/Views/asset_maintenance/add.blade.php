...
@endif
 <div class='row'>
    <form action="{{ route('asset_maintenance.saving') }}" method="POST" enctype="multipart/form-data">
    @csrf
...
<input type='text' name='form_maintenance_date' value='{{ old('form_maintenance_date') }}' class='form-control datepicker' placeholder='form_maintenance_date'>
</div>
</div>
...
<div class='form-group'>
<strong>Cost:</strong>
<input type='number' name='form_cost' min="0" value='{{ old('form_cost') }}' class='form-control' placeholder='form_cost'>
</div>
</div>
