...
@endif
 <div class='row'>
            <form action="{{ route('asset_assignments.updating',['id' => $asset_assignments->id]) }}" method="POST"  enctype="multipart/form-data">
@csrf

<div class='col-xs-12 col-sm-12 col-md-12'>
<div class='form-group'>
<strong>Assigned_Date:</strong>
<input type='text' name='form_assigned_date' value='{{ $asset_assignments->assigned_date }}' class='form-control' placeholder='form_assigned_date'>
</div>
</div>
...
<input type='text' name='form_expected_return_date' value='{{ $asset_assignments->expected_return_date }}' class='form-control' placeholder='form_expected_return_date'>
</div>
</div>
...
<input type='text' name='form_returned_date' value='{{ $asset_assignments->returned_date }}' class='form-control' placeholder='form_returned_date'>
</div>
</div>
...
<input type='text' name='form_remarks' value='{{ $asset_assignments->remarks }}' class='form-control' placeholder='form_remarks'>
</div>
</div>
